...
class GNNPrototypeBased(PrototypeBased, abc.ABC):
    def __init__(
        self,
        cfg: DictConfig,
        feature_dim: int,
...
class GNNPrototypeFromGraphs(GNNPrototypeBased, abc.ABC):
    def __init__(
        self,
        cfg: DictConfig,
        feature_dim: int,
    ...
    def compute_prototypes(
        self, episode_embedded_supports: torch.Tensor, batch: EpisodeBatch, **kwargs
        ...
        labels_per_episode = batch.global_labels.view(num_episodes, batch.episode_hparams.num_classes_per_episode)
...
class GNNPrototypeFromNodes(GNNPrototypeBased, abc.ABC):
    def __init__(
        self,
        cfg: DictConfig,
        feature_dim: int,
    ...
    def compute_prototypes(
        self, episode_embedded_support_nodes: torch.Tensor, batch: EpisodeBatch, **kwargs
    ) -> List[Dict[int, torch.Tensor]]:
        """
