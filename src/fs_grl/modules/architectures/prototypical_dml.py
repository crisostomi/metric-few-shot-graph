...
class PrototypicalDML(abc.ABC, nn.Module):
    ...
    def align_queries_prototypes(
        ...
        embedded_queries_per_episode = embedded_queries.split(
            tuple([batch.episode_hparams.num_queries_per_episode] * num_episodes)
        )
    ...
    def compute_intraclass_var_reg(
        ...
        embedded_supports_by_episode = embedded_supports.split(
            [batch.episode_hparams.num_supports_per_episode] * batch.num_episodes
        )
